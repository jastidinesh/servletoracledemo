...
<script type="text/javascript">
	...
	<form name="creditchartupdate" action="/DBO/CreditChartUpdate" method="post">
		<input type="hidden" name="start">
		<input type="hidden" name="end">
		<input type="hidden" name="title">
		<input type="hidden" name="id">
		<input type="hidden" name="user" value="res_leader">
	</form>	
...
<script type="text/javascript">
	function update(button_id)
	{
		...
		if(res == "" || res < 0 || rev == "" || res < 0 || com == "" || com < 0)
			{
				alert("The values cannot be empty or negative");
			}
		else
			{
			document.rescredit.res.value = res;
			document.rescredit.rev.value = rev;
	...
	<form name="rescredit" action="/DBO/ResCreditsUpdate" method="post">
	...
	<script>
		...
		row.insertCell(0).innerHTML = '<input type="number" id=res value='+res+' maxvalue="100">';
		row.insertCell(1).innerHTML = '<input type="number" id=rev value='+rev+' maxvalue="100">';
		row.insertCell(2).innerHTML = '<input type="number" id=com value='+com+' maxvalue="100">';
		row.insertCell(3).innerHTML = '<p data-placement="top" data-toggle="tooltip" title="Update"><button class="btn btn-primary btn-sm"  data-toggle="modal" onclick="update()">Update</button></p>';
