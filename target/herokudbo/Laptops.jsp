...
<!-- ----------------------------------------------------------------------------------------------------------------- --> 
	...
	if(user == null){
      ...
      <form action="/BrandChange" method="post" id="form_brand">
      <input type="hidden" name="brand">
      <input type="hidden" name="user">
      </form>
      <form action="/TypeChange" method="post" id="form_type">
      ...
      <input type="hidden" name="user">
   	...
   	<div class="container">
		<div class="row">
			...
			<form action="/LapCom" method="post" id="get_com">
				<input type="hidden" name="user">
...
<!-- --------------------------------------------------------------------------------------------------------------------- -->      
      <div class="modal fade" id="addcom" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
       ...
       <form method="post" id="myform" action="/AddLapCom">
